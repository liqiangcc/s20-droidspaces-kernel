...
The OSRC source-download flow is hCaptcha-gated. No archive was downloaded
because the exact firmware query already returned zero results; bypassing that
fact with the older HK package or the SM-G9860 package would not establish an
exact match.
